...
<div align="center">
  ...
  <a href="https://portfolio-roan-two-60.vercel.app/" target="_blank">
    <img src="https://akshayrathore.me" height="25" alt="portfolio logo" />
  </a>
</div>
...
|:----------:|:---------------|:---------------|:---------|
| **🌐 Portfolio Website** | Responsive personal portfolio with modern UI/UX, showcasing projects and skills with smooth animations | `React` `CSS3` `JavaScript` `Vercel` | [🔗 Live Demo](https://akshayrathore.me) |
...
[![Portfolio](https://akshayrathore.me)
